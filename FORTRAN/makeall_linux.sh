...
#
# 5/4/2023 - This version is compatible with Linux. The makefile for plot_wk uses a 
# special flag -mcmodel=medium that allows for large static arrays (>2GB).
#
...
###### plot_wk ########################
echo "plot_wk"
MAKEPATH="./MINEOS/prog_plotwk_linux/"

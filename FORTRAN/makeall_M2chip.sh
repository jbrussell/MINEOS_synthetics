...
#
# 5/4/2023 - This version is compatible with the Apple M2 chip. The main change is
# that static arrays cannot be too large (< 2GB) otherwise the program will crash.
# This requires reducing nbranch and maxn in parameter.h for plot_wk.
#
...
###### plot_wk ########################
echo "plot_wk"
MAKEPATH="./MINEOS/prog_plotwk_M2/"
